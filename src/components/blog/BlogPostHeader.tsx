...
export function BlogPostHeader({ post }: { post: PostMeta }) {
  ...
  return (
    <header className="relative overflow-hidden bg-gradient-to-b from-brand-50 to-surface pt-32 pb-12 sm:pt-40">
      ...
      <div className="relative mx-auto max-w-3xl px-5 sm:px-8">
        ...
        <h1 className="mt-4 text-3xl font-extrabold leading-tight tracking-tight text-brand-900 sm:text-4xl">
          {post.title}
        </h1>
