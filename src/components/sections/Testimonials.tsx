...
export function Testimonials() {
  ...
  return (
    <section className="bg-white py-20 dark:bg-[#070e1c] sm:py-28">
          ...
          {t.items.map((item, i) => (
            <Reveal key={item.name} delay={i * 100}>
              <figure className="flex h-full flex-col rounded-3xl border border-brand-100 bg-gradient-to-b from-brand-50/50 to-white p-7 shadow-sm dark:border-white/10 dark:from-slate-900 dark:to-slate-900">
                ...
                <blockquote className="-mt-3 flex-1 text-[0.95rem] leading-relaxed text-ink/80 dark:text-brand-100/85">
                  {item.quote}
                </blockquote>
