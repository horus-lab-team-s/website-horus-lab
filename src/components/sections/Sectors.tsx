        ...
        <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {s.items.map((item, i) => (
            <Reveal key={item} delay={i * 60}>
              <div className="group flex h-full items-center gap-3 rounded-2xl border border-brand-100 bg-white px-5 py-5 transition-all duration-300 hover:-translate-y-1 hover:border-brand-300 hover:shadow-lg hover:shadow-brand-900/5">
