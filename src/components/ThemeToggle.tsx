...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="grid size-10 place-items-center rounded-full border border-brand-200 text-brand-700 transition-colors hover:bg-brand-50 dark:border-white/15 dark:text-brand-200 dark:hover:bg-white/5"
    >
