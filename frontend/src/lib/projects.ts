...
const GRADIENTS = [
  ...
  "from-slate-800 via-brand-700 to-amber-500", // Gathe Finance — premium fintech
...
const PROJECTS: Record<Lang, Project[]> = {
  fr: [
    ...
    },
    {
      ...
      desc:
        "Plateforme de gestion financière pensée pour les indépendants et les PME africaines : suivi multi-comptes (espèces, mobile money, banque), catégorisation automatique des opérations, budgets et objectifs, tableaux de bord et reporting (trésorerie, P&L). Conçue pour la simplicité d'usage et la fiabilité des chiffres.",
  ...
  en: [
    ...
    },
    {
      ...
      desc:
        "Financial management platform built for African freelancers and SMEs: multi-account tracking (cash, mobile money, bank), auto-categorisation, budgets and goals, dashboards and reporting (cash flow, P&L). Designed for clarity of use and accuracy of numbers.",
      tags: ["Next.js", "TypeScript", "Prisma", "Postgres", "PWA"],
