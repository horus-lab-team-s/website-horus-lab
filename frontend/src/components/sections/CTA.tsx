...
export function CTA() {
  ...
  return (
    <section className="relative overflow-hidden bg-white px-5 py-14 dark:bg-[#070e1c] sm:px-8 sm:py-20">
      <Reveal className="relative mx-auto max-w-5xl">
        <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-brand-800 via-brand-700 to-brand-900 px-7 py-10 text-center shadow-2xl shadow-brand-900/40 sm:px-16 sm:py-12">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
            ...
            <Image src="/logo-HORUS-LAB-white.jpeg" alt="" width={460} height={460}
              className="absolute -right-10 -bottom-10 w-72 opacity-[0.06] mix-blend-screen" />
          </div>
