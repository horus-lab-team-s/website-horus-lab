...
class Command(BaseCommand):
    ...
    def seed_site_settings(self):
        SiteSettings.objects.update_or_create(
            ...
            defaults=dict(
                ...
                # Reseaux affiches : LinkedIn, Facebook, WhatsApp.
                # X, GitHub et Telegram retires du site le 2026-08-05.
                linkedin_url="https://www.linkedin.com/in/brailain-loic-tonba-djimgou-483215259",
                facebook_url="https://www.facebook.com/HorusLab",
                whatsapp_url="https://wa.me/237659902191",
                x_url="",
                github_url="",
                telegram_url="",
            ),
    ...
    def seed_formations_promo(self):
        ...
        FormationsPromo.objects.update_or_create(
            ...
            defaults=dict(
                ...
                badge_fr="Aperçu",
                badge_en="Preview",
                title_fr="La formation complète se poursuit sur l'appli Edlearning",
    ...
    def seed_process(self):
        steps = [
            ("Écoute & cadrage", "Listen & scope",
             ...
             "We analyse your needs, market and constraints to define a shared vision."),
    ...
    def seed_testimonials(self):
        ...
        items = [
            ("Paule Diane Himsta",
             "Présidente-Directrice Générale · Broad Range Consulting (CFP-BRC)",
            ...
            ("Paule Diane Himsta",
             "Présidente-Directrice Générale · CGA Broad Range Consulting",
    ...
    def seed_team(self):
        ...
        members = [
            ...
            dict(
                ...
                linkedin_url="https://www.linkedin.com/in/brailain-loic-tonba-djimgou-483215259",
                github_url="",
                whatsapp_url="https://wa.me/237696902054",
    ...
    def seed_blog(self):
        ...
        posts = [
            ...
            dict(
                ...
                bfr="NVIDIA a dévoilé Blackwell, sa nouvelle architecture GPU, avec des performances doublées par rapport à Hopper sur les charges de travail LLM. Pour les startups et entreprises africaines qui veulent intégrer l'IA dans leurs produits, cela signifie des coûts d'inférence dans le cloud en baisse constante.\n\nConcrètement : des assistants clients alimentés par de grands modèles de langage deviennent accessibles à des budgets PME. Horus-Lab suit ces évolutions de près pour vous proposer les bonnes architectures au bon moment.",
            ...
            dict(
                ...
                bfr="Claude 4 se distingue par sa capacité à raisonner sur de longs documents (200K tokens de contexte) et ses améliorations en génération de code. Pour les équipes qui construisent des outils de traitement documentaire ou d'assistance au développement, c'est un bond significatif.\n\nL'API reste accessible et les tarifs compétitifs font de Claude 4 un candidat sérieux pour les intégrations en Afrique.",
    ...
    def seed_portfolio(self):
        ...
        items = [
            ...
            dict(
                ...
                description_en="Web application for management and supervision in the electrical and industrial sector: equipment monitoring, real-time dashboards, alerts and reporting. Built for energy professionals who want to run their infrastructure with precision.",
                role_fr="Conception & développement", role_en="Design & development",
